...
export default function MatchPreview() {
  ...
  const entries: MatchEntry[] = names.slice(0,count).map((name,i)=>({id:String(i),name,points:Math.max(0, [12,11,8][i] ?? 8-i),stage:i===0?stage:1,status:i===0&&out?'out':'playing',lastAction:i===0?action:'ready',delta:0,history:[5,4,3]}))
