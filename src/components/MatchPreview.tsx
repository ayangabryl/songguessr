...
export default function MatchPreview() {
  ...
  if (match) match.completedRounds = [
    {roundId:'earlier-win',number:1,answer:{id:'melody-one',title:'A quiet afternoon',artist:'Original preview melody'},results:entries.map(e=>({id:e.id,stage:0,status:'solved',lastAction:'solved',delta:5000,attempts:[]}))},
