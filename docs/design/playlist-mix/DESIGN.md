...
Spotify sources: [Get Playlist Items](https://developer.spotify.com/documentation/web-api/reference/get-playlists-items) and [Get Playlist](https://developer.spotify.com/documentation/web-api/reference/get-playlist). Public preview fallback is deliberately partial, imports no audio, and only intersects exact IDs already in the playable catalog. A selected mix is a snapshot; remove and add it again to refresh membership.
